...
?>
<h2>Üdvözlet <?= Html::decode(Yii::$app->user->identity->vezeteknev . ' ' . Yii::$app->user->identity->keresztnev) ?>
    !</h2>
<p>(nem <?= Html::decode(Yii::$app->user->identity->vezeteknev . ' ' . Yii::$app->user->identity->keresztnev) ?>? – <a
            href="<?= Url::to(['/site/logout']) ?>">Kijelenetkezés</a>)
</p>
