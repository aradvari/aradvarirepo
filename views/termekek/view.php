                            ...
                            if (count($model->vonalkodok) >= 1) {
                                foreach ($model->vonalkodok as $vonalkod) {
                                    ...
                                    <label for="v_<?= $vonalkod->vonalkod ?>"
                                           ...
                                           title="<?= $vonalkod->keszlet_1 ?> db raktáron"
                                           style="<?= $vonalkod->megnevezes == '-' ? 'display:none' : '' ?>"><?= $vonalkod->megnevezes ?></label>
                    ...
                    <select name="mennyiseg" class="form-control number-product"></select>
                        ...
                        <div class="kifutott_termek">
                            <div class="padding-20">
                                ...
                                <p>Nézd meg aktuális kínlatunkat, bízunk benne találsz kedvedre valót újdonságaink
                                    között.</p>
                            </div>
                        </div>
