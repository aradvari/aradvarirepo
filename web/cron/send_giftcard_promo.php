...
while ($adatok = mysql_fetch_assoc($query)){
        ...
        <table width="100%" align="center" bgcolor="#000" border="0" class="main" cellpadding="0">
            ...
            <tr>
                ...
                <table class="main" border="0" width="400">
                    ...
                    <br />
                    <br />
                    <div style="border-bottom:1px solid #333;">'.$adatok['uzenet'].'
                    <br />
                    <br />
                    </div>
                    <br />
                    <font size="2" style="color:#9EB91B;" color="#9EB91B"><b>'.$adatok['felado_nev'].'</b></font> Coreshop online ajándékkártyát küldött neked, melynek vásárlási értéke:
                    <br />
                    <br />
                    <div class="button"><font size="2" style="color:#9EB91B;" color="#9EB91B">'.number_format($adatok['osszeg'], 0, '', '.').',- Ft</font></div>
                    <br />
                    A kártyát felhasználhatod a Coreshop webáruházában.
                    <br />
                    <br />
                    Áruházunk címe: <a href="http://coreshop.hu" target="_blank"><font size="2" style="color:#9EB91B;" color="#9EB91B">www.coreshop.hu</font></a> .
                    <br />
                    <br />
                    Egyedi azonosítód:
                    <br />
                    ...
                    <br />
                    A kártya értékét a fenti kóddal tudod felhasználni.
                    <br />
                    <br />
    ...
    $mail->Body = '
        ...
        .content  {  width:620px;  padding:10px; color: #FFF;  text-align:left;    background-image: url(http://test.coreshop.hu/images/egiftcard/mail-bg.jpg); background-position:top center; background-repeat: no-repeat; }
        ...
        .button    {    text-align:center; color: #FFF;    font-size: 16px;    font-weight: bold;    text-decoration:normal; border:1px solid #333; margin:0 10px 0 10px; padding:5px;    }
        -->
        </style>
        ...
        <table width="100%" align="center" bgcolor="#000" border="0" class="main" cellpadding="0">
            ...
            <tr>
                ...
                <table class="main" border="0" width="400">
                    ...
                    <br />
                    <br />
                    Örömmel értesítünk, hogy elindult a Coreshop új szolgáltatása, a Virtual Gift Card, vagyis az online ajándékkártya küldés lehetõsége.
                    <br />
                    <br />
                    Az indulás alkalmából a Coreshop megajándékoz egy 
                    <br />
                    <br />
                    <div class="button"><font size="2" style="color:#9EB91B;" color="#9EB91B">2.000 Ft</font></div>
                    <br />
                    értékû ajándékkártyával, melyet <b><font size="2" style="color:#9EB91B;" color="#9EB91B">2010. december 31</font></b>-ig használhatsz fel <b><font size="2" style="color:#9EB91B;" color="#9EB91B">5.000 Ft</font></b>-ot meghaladó rendelés esetén. 
                    <br />
                    <br />
                    <br />
                    A kártyát felhasználhatod a Coreshop webáruházában.
                    ...
                    <br />
                    <br />
                    A kártya felhasználásának részleteirõl <a href="http://www.coreshop.hu/ajandekkartya"><font size="2" style="color:#9EB91B;" color="#9EB91B">bõvebben itt olvashatsz</font></a>.
                    <br />
                    <br />
                    Coreshop
