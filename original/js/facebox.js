...
$.extend($.facebox,{settings:{opacity:0.2,overlay:true,loadingImage:'/js/loading.gif',closeImage:'/js/closelabel.png',imageTypes:['png','jpg','jpeg','gif'],faceboxHtml:'\
    <div id="facebox" style="display:none;"> \
      <div class="popup"> \
        <div class="content"> \
        </div> \
        <a href="#" class="close"><img src="/js/closelabel.png" title="close" class="close_image" /></a> \
      </div> \
