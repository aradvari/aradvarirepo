...
while ($adatok = mysql_fetch_assoc($query))	{
	...
	$ph .= $adatok['id'].',,"'.$termeknev.'","'.$item_subtitle.'","'.$item_description.'","1163 Cziráki utca 26-32, Budapest, Hungary, 47.507638, 19.161153","'.$adatok['kisker_ar'].' HUF",'.$akcios_kisker_ar.',"https://coreshop.hu/'.$img.'1_large.jpg?17",,"'.$item_subtitle.'",,"https://coreshop.hu/hu/termek/'.$func->convertString($adatok['termeknev']).'/'.$adatok['id'].'"'.PHP_EOL;
