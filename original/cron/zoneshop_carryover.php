...
$sql = "SELECT
	...
	t.id IN (4454,4455,5358,6068,6733,7127,7132,6058,6174,4437,4436,4435,1579,4511,5807,7151,5487,7041,2969,3013,7092,6733,4709,4476)
...
$file_handle = fopen("zoneshop_carryover.csv", "w");
$file_contents = $ph;

fwrite($file_handle, $file_contents);
fclose($file_handle);
print "Zoneshop carry over csv export kesz<br /><br />";
