...
// start a PHP session - this class uses sessions to store the generated 
   ...
   //define('CAPTCHA_FLITE_PATH', '/srv/web/z/i/zip2000/mindennapi.hu/page/external/captcha/');
   //define('CAPTCHA_FLITE_PATH', 'c:\\wamp\\www\\mindennapi\\external\\captcha\\');
   ...
   class PhpCaptcha {
      ...
      function DrawLines() {
         for ($i = 0; $i < $this->iNumLines; $i++) {
            // allocate colour
            if (1==2){ //if ($this->bUseColour) {
               $iLineColour = imagecolorallocate($this->oImage, 250, 250, 250);
            } else {
               $iRandColour = rand(100, 250);
               $iLineColour = imagecolorallocate($this->oImage, rand(10, 100), rand(10, 100), rand(10, 100));
            }
      ...
      function DrawOwnerText() {
         ...
         $iBlack = imagecolorallocate($this->oImage, 30, 130, 80);  //betuszin
      ...
      function GenerateCode($code='') {
         ...
         if ($code==""){
             ...
             $this->sCode = $code;
             $_SESSION[CAPTCHA_SESSION_ID] = $code;
      ...
      function DrawCharacters() {
         ...
         for ($i = 0; $i < strlen($this->sCode); $i++) {
            ...
            if ($this->bUseColour) {
               $iTextColour = imagecolorallocate($this->oImage, rand(200, 250), rand(200, 250), rand(200, 250));
               ...
               $iRandColour = rand(100, 200); //betuszin
            ...
            $iX = (85 - (strlen($this->sCode)*17)) + $this->iSpacing / 4 + $i * $this->iSpacing;
      ...
      function Create($sFilename = '', $code = '') {
         ...
         imagecolorallocate($this->oImage, 0, 0, 0); //hatter
