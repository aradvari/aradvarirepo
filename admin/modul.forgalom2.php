...
mf.fizetendo,
mf.giftcard_osszeg ajandekkartya
...
while ($adatok = mysql_fetch_assoc($query)){
	...
	$ajandekkartya_osszesen = $ajandekkartya_osszesen + $adatok['ajandekkartya'];
}
...
$table.= '<tr style="height:25px;font-weight:bold">
		...
		<td align="right" class="darkCell">Bruttó ajándékkártya</td>
...
if (is_array($marka)){
    ...
    while ($adatok = each($marka)){
		...
		//netto arres ossz
		$netto_arres_ossz=$netto_arres_ossz+$netto_arres-$adatok[1]['ajandekkartya'];
        ...
        $table.= '<tr class="'.$style.'">
					...
					<td align=\"right\" style='color:#666;'>".number_format($adatok[1]['ajandekkartya'],0, '', ' ')." Ft</td>
					...
					<td align=\"right\" style='color:#666;'>".number_format($netto_arres-$adatok[1]['ajandekkartya'],0, '', ' ')." Ft</td>					
...
$table.= '<tr style="height:25px;font-weight:bold">
			<td></td>
			<td align="right" class="darkCell">'.number_format($osszesen_db, 0, '', ' ').' db</td>
			<td align="right" class="darkCell">'.number_format($osszesen, 0, '', ' ').' Ft</td>
			
			<td align="right" class="darkCell">'.number_format($ajandekkartya_osszesen, 0, '', ' ').' Ft</td>
			
			<!--- <td align="right" class="darkCell" style="color:;">'.number_format(($osszesen/1.27), 0, '', ' ').' Ft</td>
			<td align="right" class="darkCell" style="color:;">'.number_format(($osszesen-($osszesen/1.27)), 0, '', ' ').' Ft</td> -->
...
$shippingtable.='<td class="darkCell" align="center">Nettó bevétel: <b>'.number_format(($netto_arres_ossz-($free_shipping_qty*850)-($ajandekkartya_osszesen)), 0, '', ' ').' Ft</b></td></tr>';
$shippingtable.='</table>';
