...
$sql = "
    SELECT 
        ...
        CONCAT(o.orszag_nev,', ',mf.szallitasi_irszam,' ',mf.szallitasi_varos,', ',mf.szallitasi_utcanev,' ',mf.szallitasi_kozterulet,' ',mf.szallitasi_hazszam,' (',mf.szallitasi_emelet,')') megrendelo_cime,
        CONCAT(o.orszag_nev,', ',mf.szamlazasi_irszam,' ',mf.szamlazasi_varos,', ',mf.szamlazasi_utcanev,' ',mf.szamlazasi_kozterulet,' ',mf.szamlazasi_hazszam) szamlazasi_cim,
  ...
  <tr>
    <td width="700">
		...
		<tr>
			...
			if (isset($prev)){ ?>
			<div style="float:left;"><input type="button" class="form" value="&lsaquo; Előző" onclick="document.location.href='index.php?lap=megrendeles&id=<?=$prev?>'" /></div>
			<? }
			
			if (isset($next)){ ?>
			<div style="float:right"><input type="button" class="form" value="Következő &rsaquo;" onclick="document.location.href='index.php?lap=megrendeles&id=<?=$next?>'" /></div>
			</td>
			<? } ?>
		</tr>
		<? } ?>
		...
		<tr>
    <td colspan=4 align="right"><a href="index.php?lap=megrendeles_szerk&id=<?=$_GET['id']?>" style="padding:4px;font-size:14px;"><img src="/images/edit.png" style="width:14px;height:14px;vertical-align:middle;padding:0 10px 2px 0;opacity:0.8;" />Szerkesztés</a></td></tr>
          ...
          <tr>
            <td class="<?=$keyCell?>">Megrendelő címe:</td>
            <td colspan="3" class="lightCell">
          ...
          <tr>
            ...
            <td colspan="" class="lightCell">
                ...
                ?>
                <b><?=$fizetesi_modok[$m['id_fizetesi_mod']]?></b> / <b><?=$szallitasi_modok[$m['id_szallitasi_mod']]?></b> 
            </td>
          ...
          <tr>
            <td colspan="4" class="lightCell" style="padding: 0;">
                <table style="min-width:910px;width:100%;" cellpadding="3">
                    ...
                    ?>					
                    <tr>
                        <td class="mediumCell" align="center"><a href="http://www.coreshop.hu/<?=$func->getHDir($t['id_termek']);?>1_large.jpg" class="highslide" onclick="return hs.expand(this)"><img src="http://coreshop.hu/<?=$func->getHDir($t['id_termek']);?>1_small.jpg" style="width:60px;height:60px;outline:2px solid #eee;" /></a></td>
						
                        <td class="mediumCell"><?=$t['vonalkod']?><br /><br /><span style="color:blue;"><b><?=$tarolo[$tarolva[0]];?></b> raktár</span></td>
          ...
          <tr>
            ...
            <td colspan="3" class="<?=$keyCell?>"><a href="index.php?lap=tranzakcio&id=<?=$m['id_bank_tranzakcio']?>"><b><?=$m['trid'];?></b></a>
			&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;ANUM (számlára ráírni):&nbsp;&nbsp;&nbsp;<b><?=$m['anum']?></b>
			</td>
          </tr>
          <tr>
            ...
            <td colspan="3" class="<?=$keyCell?>">
                <b><?=$m['statusz_nev'];?></b>
                <span id="keszlet_div" style="display:none"><input type="checkbox" name="tetelek_vissza" style="vertical-align:middle"> tételek visszarakása a készletbe </span>
            </td>
          </tr>
          <tr>
            <td colspan="4" class="<?=$keyCell?>">				
                <?
                    if ($m['id_statusz']==1){
                ?>
                    <input type="button" class="form" value=" Lezárás " onclick="document.location.href='index.php?lap=megrendeles&id=<?=$m['id_megrendeles_fej']?>&id_statusz=3'" />
					&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
					
					<div class="storno_button"><input type="button" value="Sztornózás" class="form" onclick="if (confirm('Biztosan sztornózza a megrendelést?')){ document.statuszFrom.submit(); }" /></div>			
				...
				<input type="button" class="form" value="&lsaquo; Vissza a listához" onclick="document.location.href='index.php?lap=megrendelesek'" />
