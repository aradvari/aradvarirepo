<?
    ...
    if (ISSET($_POST['rename'])){
        ...
        foreach (glob($small_directory."/*.jpg") as $filename) {
            ...
            if (@rename($filename, $func->createHDIR($id, "../ct.coreshop.hu/pictures/termekek/").$newname."_small.jpg")) $ok++; else $error++;
        ...
        foreach (glob($large_directory."/*.jpg") as $filename) {
            ...
            if (@rename($filename, $func->createHDIR($id, "../ct.coreshop.hu/pictures/termekek/").$newname."_large.jpg")) $ok++; else $error++;
