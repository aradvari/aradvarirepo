...
echo '<form methon="GET" action="" />
		...
		<input type="hidden" name="lap" value="termekek_sorrend" />
		
		<table width="400" border="0" cellspacing="1" cellpadding="6">
		
		<tr><td class="lightcell" style="font-weight:bold; color:red;">SORREND</td></tr>
...
$sql="SELECT
		...
		WHERE opcio='UJ' and kategoria=".$_SESSION['termekek']['kategoria']." AND
		v.keszlet_1>0 AND
		t.aktiv=1
