...
if (ISSET($_POST['szures'])) {
    ...
    $_SESSION['felhasznalok']['auth_type'] = $_POST['auth_type'];
    ...
    $_SESSION['felhasznalok_query'] =
        ...
        . ($_POST['auth_type'] == "" ? "" : " AND f.auth_type = '" . $_POST['auth_type'] . "'")
    ...
    <table border="0" cellspacing="1" cellpadding="2">
        <tr>
            ...
            <td width="200" class="lightCell">
                <input type="text" style="width:80px" name="id_tol" value="<?= $_SESSION['felhasznalok']['id_tol'] ?>"
                       placeholder="<?= ($_COOKIE['admin_felhasznalokid_ig'] + 1); ?>"/> - <input type="text"
                                                                                                  style="width:80px"
                                                                                                  name="id_ig"
                                                                                                  value="<?= $_SESSION['felhasznalok']['id_ig'] ?>"/>
            </td>
            <td width="100" class="darkCell" align="center">Név</td>
            <td width="200" class="lightCell"><input type="text" style="width:100%" name="nev"
                                                     value="<?= $_SESSION['felhasznalok']['nev'] ?>"></td>
            <td width="100" class="darkCell" align="center">Telefon</td>
            <td width="200" class="lightCell"><input type="text" style="width:100%" name="telefon"
                                                     value="<?= $_SESSION['felhasznalok']['telefon'] ?>"></td>
        </tr>
        <tr>
            <td width="100" class="darkCell" align="center">E-mail cím</td>
            <td width="200" class="lightCell"><input type="text" style="width:100%" name="email"
                                                     value="<?= $_SESSION['felhasznalok']['email'] ?>"></td>
            <td width="100" class="darkCell" align="center">Lakcím</td>
            <td width="200" class="lightCell"><input type="text" style="width:100%" name="lakcim"
                                                     value="<?= $_SESSION['felhasznalok']['lakcim'] ?>"></td>
        ...
        <tr>
            ...
            <td width="100" class="darkCell" align="center">Klubtag / Van kártyája?</td>
            <td width="200" class="lightCell">
                <?
            ...
            <td width="100" class="darkCell" align="center">Reg. típusa</td>
            <td width="200" class="lightCell">
                <?
                echo $func->createArraySelectBox(array("normal" => "Normál", "facebook" => "Facebook", "google" => "Google", "" => "Mindegyik"), $_SESSION['felhasznalok']['auth_type'], "name=\"auth_type\"", "");
                ?>
            </td>
        </tr>
        <tr>
            <td class="darkCell" align="center" colspan="6"><input type="submit" class="form" value="szűrés"
                                                                   name="szures"/> <input type="submit" class="form"
                                                                                          value="alaphelyzet"
                                                                                          name="alaphelyzet"/></td>
        </tr>
    </table>
...
<table border="0" cellspacing="1" cellpadding="2">
    ...
    WHERE 
      f.torolve IS NULL " . $_SESSION['felhasznalok_query'] . " AND
      f.auth_type != 'unregistered'
    GROUP BY f.id
    " . $_SESSION['felhasznalok_having'] . "	
    ORDER BY f.id DESC	
  ";
    ...
    f.auth_type `Regisztráció típusa`
    FROM felhasznalok f
    LEFT JOIN felhasznalok_karkoto fk ON (fk.id_felhasznalo = f.id)
    WHERE 
    f.torolve IS NULL AND f.auth_type != 'unregistered' " . $_SESSION['felhasznalok_query'] . "
    ORDER BY f.id DESC
  ";
	...
	f.orszag_nev
    FROM felhasznalok f
    WHERE f.torolve IS NULL AND f.auth_type != 'unregistered' " . $_SESSION['felhasznalok_query'] . "
  ...
  ";
    ...
    echo '<tr align="center">
		  ...
		  <td width="70" class="darkCell">Klubtag</td>
		  <td width="70" class="darkCell">Hírlevél</td>
		  <td width="70" class="darkCell">Reg. típusa</td>
		  <td width="70" class="darkCell">Aktív</td>
		  <td width="50" class="darkCell">&nbsp;</td>
	</tr>';
    ...
    while ($adatok = mysql_fetch_array($query_user)) {
        ...
        echo '<td onClick="document.location.href=\'index.php?lap=felhasznalo&id=' . $adatok['id'] . '\'"><div align="right">' . $adatok['id'] . '&nbsp;</div></td>
          ...
          <td onClick="document.location.href=\'index.php?lap=felhasznalo&id=' . $adatok['id'] . '\'"><div align="center">' . $adatok['auth_type'] . '</div></td>
